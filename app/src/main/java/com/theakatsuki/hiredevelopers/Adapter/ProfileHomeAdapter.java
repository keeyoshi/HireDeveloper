...
public class ProfileHomeAdapter extends RecyclerView.Adapter<ProfileHomeAdapter.ViewHolder> {
    ...
    public ProfileHomeAdapter(Context myContext, List<Events> events ) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final ProfileHomeAdapter.ViewHolder holder, int position) {
